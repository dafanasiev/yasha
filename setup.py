...
setup(
    ...
    description="yasha cli",  # Optional
    ...
    url="https://github.com/dafanasiev/yasha",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Dmitry Afanasiev",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="afanasiev.dmitry@gmail.com",  # Optional
    ...
    keywords="yasha development",  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/dafanasiev/yasha/issues",
        "Source": "https://github.com/dafanasiev/yasha/",
    },
)
